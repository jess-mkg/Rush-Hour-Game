...
If all problems are wanted input the values 0 and 40 when prompted. 
Results will not print to the screen but will print to a file that the user will be asked to name. 
